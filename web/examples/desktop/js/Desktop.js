...
Ext.define('Ext.ux.desktop.Desktop', {
	...
	reloadShortcuts: function(shotcutsData) {
		var me = this;
		me.shortcuts = shotcutsData;
		me.shortcutsView.getStore().loadRecords(shotcutsData);
	},
    //------------------------------------------------------
    ...
    createDesktopMenu: function () {
        ...
        ret.items.push(
                { text: '列成一排', handler: me.tileWindows, scope: me, minWindows: 1 },
                { text: '瀑布状', handler: me.cascadeWindows, scope: me, minWindows: 1 })
